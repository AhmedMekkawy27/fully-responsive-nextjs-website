            ...
            <div className={`flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10`}>
                ...
                <div className={`flexCenter gap-6`}>
                    <span className={`flex -space-x-4`}>
                        {PEOPLE_URL.map( (url) =>(
                            <Image src={url} key={url} width={42} height={40} style={{ width: '42px', height: '40px' }} alt="person"/>
                        ))}
                    </span>
        ...
        <section className={`2xl:max-container relative
         flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20`}>
            <div className={`hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8
             overflow-x-auto lg:h-[400px] xl:h-[640px] 2xl:rounded-3xl`}>
            ...
            <div className={`flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6`}>
                ...
                xl:rounded-5xl xl:px-16 xl:py-20 relative w-full rounded-3xl`}>
                    ...
                    <p className={`regular-14 xl:regular-16 mt-5 text-white`}>
                        ...
                        when visiting a new climbing location, the possibility
                        of getting lost is very large. That's why we are here
