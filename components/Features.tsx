            ...
            <div className={`max-container flex padding-container relative w-full justify-end`}>
                <div className={`flex flex-1 lg:min-h-[900px]`}>
                    <Image src="/phone.png" alt="phone"
                           width={440} height={1000} className={`feature-phone`}/>
                </div>
                ...
                <div className={`z-20 flex w-full flex-col lg:w-[60%]`}>
                    ...
                    <ul className={`mt-10 grid md:grid-cols-2 lg:mg-20 lg:gap-20`}>
...
const FeatureItem = ({title, icon, description}:FeatureItem) =>{
    return(
        <li className={`flex w-full flex-1 flex-col items-start mb-11`}>
